...
<html lang="en" oncontextmenu="return false">
  <head>
    ...
    <title>THAPARTALKS - Viewer</title>
        ...
        <div class="templatemo-content-container">
          ...
          <div class="col-1">
              <div class="panel panel-default margin-10">
                       ...
                       <div class="panel-heading"><h2 style="display:inline-block;" class="text-uppercase"><a href="<?php echo $_SERVER['HTTP_REFERER']; ?>"><img src="images/back2.png" style="width:35px; height:auto; padding-right:10px;"></a><?php echo $type; ?></h2></div>
                <div class="panel-body">  
                <?php if($type=='image'){
                  ?>
                 
                  <img onerror="this.onerror=null;this.src='images/unknown.png';" src="<?php if($_GET['p']==1){ echo $file;} else{echo $file;} ?>" style="width:100%; height:auto; pointer-events: none; user-select: none; cursor: default;" unselectable="on">
                <?php }
                else if($type=='video'){
                  ?>
                ...
                elseif($type=='doc'){
                ?>
                <iframe src="<?php echo $file; ?>" style="width:100%; height:600px;" frameborder="0"></iframe>
