    	 ...
    	 <div class="well profile">
            <div class="col-sm-12">
                <div class="col-xs-12 col-sm-12">
                    <h2><img src="images/logo.PNG" style="width:50px; height:auto;">ThaparTalks</h2><br>
                    ...
                    <p><span style="padding-bottom:200px;"><strong >Aim: </strong><span>Our aim is to provide a cocoon like social platform where students can communicate with each other </p>
            ...
            <div class="col-xs-12 divider text-center">
              ...
              <h5>BE-C0E, TIET ,Patiala</h5>
                <div class="col-xs-12 col-sm-6 emphasis">
                    ...
                    <button class="btn btn-success btn-block"><span class="fa fa-plus-circle"></span> Send Request </button>
                </div>
                <div class="col-xs-12 col-sm-6 emphasis">
