...
<html lang="en" oncontextmenu="return false">
  <head>
    ...
    <title>THAPARTALKS - Access Denied</title>
        ...
        <div class="templatemo-content-container">
          ...
          <div class="col-1">
              <div class="panel panel-default margin-10"> 
                <div class="panel-heading"><h2 style="display:inline-block;" class="text-uppercase"><a href="<?php echo $_SERVER['HTTP_REFERER']; ?>"><img src="images/back2.png" style="width:35px; height:auto; padding-right:10px;"></a>You both are not buddies</h2></div>
                <div class="panel-body">  
                  <img onerror="this.onerror=null;this.src='images/unknown.png';" src="images/access_denied.jpg" style="width:100%; height:auto; pointer-events: none; user-select: none; cursor: default;" unselectable="on">
                </div> 
             </div>     
          </div>   
